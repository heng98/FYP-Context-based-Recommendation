...
def create_citation_network(dict_path):
    ...
    with open(
        "Dataset/aan/release/2014/networks/paper-citation-network-nonself.txt", "r"
    ) as f:
        for line in f.readlines():
            p1, p2 = line.split(" ==> ")
...
def train_test_split(df, papers_dir_path, year=2013):
    ...
    dataset = {"name": "AAN", "train": train, "test": test}
...
if __name__ == "__main__":
    ...
    json.dump(dataset, open(f"{arg.save_path}/aan_dataset.json", "w"), indent=2)
